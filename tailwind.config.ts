...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "brick-pattern": "repeating-linear-gradient(0deg, transparent, transparent 19px, rgba(0,0,0,0.04) 19px, rgba(0,0,0,0.04) 20px), repeating-linear-gradient(90deg, transparent, transparent 39px, rgba(0,0,0,0.04) 39px, rgba(0,0,0,0.04) 40px)",
        "hero-gradient": "linear-gradient(135deg, #000000 0%, #0D0D0D 60%, #111111 100%)",
        "terracotta-gradient": "linear-gradient(135deg, #8B4513 0%, #6B340F 100%)",
        "lime-gradient": "linear-gradient(135deg, #00CC00 0%, #009900 100%)",
        "sand-gradient": "linear-gradient(180deg, #F0F0F0 0%, #FFFFFF 100%)",
        "warm-gradient": "linear-gradient(180deg, #FFFFFF 0%, #F0F0F0 100%)",
      },
      animation: {
      ...
      keyframes: {
        ...
        farolGlow: {
          "0%, 100%": { filter: "drop-shadow(0 0 8px #00CC0066) brightness(1)" },
          "50%": { filter: "drop-shadow(0 0 24px #00CC00BB) brightness(1.15)" },
        },
        floatParticle: {
      ...
      boxShadow: {
        ...
        "farol": "0 0 30px rgba(0,204,0,0.35), 0 0 60px rgba(0,204,0,0.15)",
